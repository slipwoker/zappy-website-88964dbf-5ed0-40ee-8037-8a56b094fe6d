document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        errorMsg = getFieldLabel(field, form) + ' is required.';
      } else if (value !== '') {
  ...
  function showFieldError(field, message) {
    ...
    const existingError = getErrorEl(field);
    ...
    const parent = field.closest('.form-group, .form-field, .input-wrapper') || field.parentNode;
  ...
  function getErrorEl(field) {
    ...
    if (describedBy) {
      ...
      if (el && el.classList.contains('form-error-message')) return el;
    }
    const parent = field.closest('.form-group, .form-field, .input-wrapper') || field.parentNode;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "T-Studio משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '88964dbf-5ed0-40ee-8037-8a56b094fe6d',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '88964dbf-5ed0-40ee-8037-8a56b094fe6d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '88964dbf-5ed0-40ee-8037-8a56b094fe6d';
